...
import (
	...
	"github.com/gaodb1210/escheduler-api/pkg/client/clientset/versioned/scheme"
...
// NodeV1alpha1Client is used to interact with features provided by the node.escheduler.sh group.
type NodeV1alpha1Client struct {
	restClient rest.Interface
}

func (c *NodeV1alpha1Client) VNodes() VNodeInterface {
	return newVNodes(c)
}
