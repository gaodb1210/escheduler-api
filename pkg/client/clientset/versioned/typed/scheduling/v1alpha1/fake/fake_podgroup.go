...
var podgroupsResource = schema.GroupVersionResource{Group: "scheduling.escheduler.sh", Version: "v1alpha1", Resource: "podgroups"}

var podgroupsKind = schema.GroupVersionKind{Group: "scheduling.escheduler.sh", Version: "v1alpha1", Kind: "PodGroup"}
